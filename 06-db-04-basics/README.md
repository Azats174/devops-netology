...
Создаем  бэкап
```
root@9f7a0c51c610:/var/lib/postgresql/data# pg_dump -U postgres -d test_database >test_database_dump.sql
```
Для уникальности нужно добавить индекс или первичный ключ.
```
